...
import { slugify, transform } from '../../utils/helpers'
...
const ItemView = (props) => {
  ...
  product.toLocaleString('id-ID', {currency: 'IDR', style: 'currency'});
    ...
    <>
      ...
      ">
        ...
        <div className="pt-2 px-0 md:px-10 pb-8 w-full md:w-1/2">
          ...
          ">{name}</h1>
          <h2 className="text-2xl tracking-wide sm:py-8 py-6">{price.toLocaleString('id-ID', {currency: 'IDR', style: 'currency'})}</h2>
