      ...
      <div className="flex flex-col items-center pb-10">
        ...
        ">
                          ...
                          <div className="flex items-center hidden md:flex">
                            ...
                            <div className="flex flex-1 justify-end">
                              <p className="m-0 pl-10 text-gray-900 tracking-wider">
                                {item.price.toLocaleString('id-ID', {currency: 'IDR', style: 'currency'})}
                              </p>
          ...
          <div className="flex flex-1 justify-end py-8">
            ...
            <p className="font-semibold tracking-wide">{total.toLocaleString('id-ID', {currency: 'IDR', style: 'currency'})}</p>
          </div>
          {!cartEmpty && (
